...
namespace Pharmacy_Management_System
{
    ...
    partial void OnlocationChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Product_purchase", Storage="_purchase", ThisKey="pid", OtherKey="purId", IsUnique=true, IsForeignKey=false)]
    ...
    partial void OntotalChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Product_purchase", Storage="_Product", ThisKey="purId", OtherKey="pid", IsForeignKey=true)]
		public Product Product
		{
			...
			set
			{
							...
							|| (this._Product.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						value.purchase = this;
						this._purId = value.pid;
					}
					else
					{
						this._purId = default(int);
					}
